...
let inicial=nombre.substring(0,1).toLowerCase();
console.log(letraNombre[inicial])

let letraFinal=apellido.substring(apellido.length-1).toLowerCase();
console.log (letraApellido[letraFinal]);

let numeroFinal=fecha.substring(fecha.length-1);
console.log (fechaNacimiento[numeroFinal])
