let personas = {
    ...
    let nombre =  prompt ("Introduce el nombre de la persona que buscas: ");
    
     

    let personaSeleccionada = personas[nombre] 
    if (personaSeleccionada==undefined){
        ...
        <img src="${personaSeleccionada.picture}"></img>
        <p id="edad"> ${personaSeleccionada.age}</p>
        <p id="email"> ${personaSeleccionada.email}</p>
        <p id="direccion"> ${personaSeleccionada.address}</p>
        </div>
    `
        document.querySelector('#main').style.backgroundColor = personaSeleccionada.eyeColor;
